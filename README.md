...
1. Clone the ctrl_pkg, camera_pkg, servo_pkg, inference_pkg, model_optimizer_pkg and the deepracer_interfaces_pkg on the DeepRacer device:

        git clone https://github.com/aws-racer/aws-deepracer-interfaces-pkg
        git clone https://github.com/aws-racer/aws-deepracer-camera-pkg
        git clone https://github.com/aws-racer/aws-deepracer-servo-pkg
        git clone https://github.com/aws-racer/aws-deepracer-inference-pkg
...
1. Build the ctrl_pkg, camera_pkg, servo_pkg, inference_pkg, model_optimizer_pkg, deepracer_navigation_pkg and deepracer_interfaces_pkg:
    ...
    colcon build --packages-select ctrl_pkg camera_pkg servo_pkg inference_pkg model_optimizer_pkg deepracer_navigation_pkg deepracer_interfaces_pkg
